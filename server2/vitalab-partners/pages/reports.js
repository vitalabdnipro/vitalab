...
const PeriodHeaderPrinting = ({ period }) => {
  ...
  return (
    <div className="hidden print:block">
      <div className="text-sm flex items-center justify-between h-8 mb-8">
        <div className="h-8"><Logo className="mx-auto"/></div>
        <div className="flex flex-col">
          <div className="font-semibold text-right mr-1">Ф-5.4-01ПЗ</div>
