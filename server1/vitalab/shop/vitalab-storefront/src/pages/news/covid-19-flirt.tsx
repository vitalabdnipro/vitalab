      ...
      <div className="pb-32">
        ...
        > */}
          ...
          <header className="col-span-3 mt-12 grid w-full max-w-[810px] gap-y-6 md:grid-in-hero">
            <Heading variant="heading">COVID-19 ПОВЕРНУВСЯ</Heading>
          ...
          <section className="grid gap-y-10 grid-in-body">
            <div className="grid gap-y-6 text-m leading-6 text-gray-900 md:text-lg">
              <p className="px-4 sm:pr-8 md:max-w-[810px]">
                COVID знову набирає обертів. Тепер ми маємо справу з новим
                субваріантом Omicron FLiRT. Цей штам отримав свою назву через
                певні мутації в спайковому білку, які допомагають йому краще
                прикріплюватися до клітин та уникати імунної відповіді. Це
                означає, що люди, які вже хворіли на COVID-19 або були
                вакциновані, також вразливі для нового штаму.
              </p>
              <p className="px-4 sm:pr-8 md:max-w-[810px]">
                Імовірно, що холодна пора принесе новий спалах захворюваності,
                тому важливо дотримуватися профілактичних заходів та робити
                щеплення.
              </p>
              <p className="px-4 sm:pr-8 md:max-w-[810px]">
              ...
              <p className="px-4 sm:pr-8 md:max-w-[810px]">
                ...
                пропонуємо зробити у Vitalab швидкий тест на COVID-19 і отримати
                результат уже через 15 хвилин зі знижкою 25%!
              </p>
            </div>
            ...
            <p className="px-4 text-s">
              *Акція діє за умови замовлення дослідження на сайті з 17.09.2024
              р. по 30.11.2024 р. Акційна ціна не враховує вартість забору
