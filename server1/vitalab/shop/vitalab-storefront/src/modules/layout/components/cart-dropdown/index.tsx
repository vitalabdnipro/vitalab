    ...
    <div className="z-50 h-full" onMouseEnter={open} onMouseLeave={close}>
      <Popover className="relative h-full">
        ...
        >
          <Popover.Panel
            static
            className="absolute top-[calc(100%+1px)] right-0 hidden w-[382px] border-x border-b border-gray-200 bg-white text-gray-900 sm:block"
          >
                        ...
                        <div className="flex flex-1 flex-col justify-between">
                          <div className="flex flex-1 flex-col">
                            <div className="flex items-start justify-between">
                              <div>
                                <h3 className="text-base-regular mr-4 w-[130px] overflow-hidden text-ellipsis whitespace-nowrap">
                                  <Link
