    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="p-6">
            <DialogTitle>Додати примітку</DialogTitle>
          </div>
          <div className="px-6 pt-6 border-t bg-[#fafafa]">
            <div>
                  ...
                  <div className="mt-1 pb-3">
                    <textarea
                      {...register("note", {
                        maxLength: {
                          value: 132,
                          message: "Максимальна довжина примітки 132 символи",
                        },
                        required: false,
                        // pattern: {
                        //   value: /^(555)[0-9]{9}$/,
                        //   message: "Формат номеру: 555xxxxxxxxx",
                        // },
                      })}
                      autoComplete="off"
                      rows="3"
                      id="note"
                      className="px-4 py-2 text-sm w-full outline-none rounded-md transition-all border focus:border-gray-400 focus:shadow-[0_0_0_2px_rgba(62,207,142,.1)] resize-none"
                    />
                    <ErrorMessage
                      errors={errors}
                      name="note"
