import{d8 as Mr,b as $}from"./index-7bbcdb2e.js";var h={},X={};for(var ur=[],p=0;p<64;)ur[p]=0|4294967296*Math.sin(++p%Math.PI);function Wr(r){var a,e,t,n=[a=1732584193,e=4023233417,~a,~e],i=[],l=unescape(encodeURI(r))+"",o=l.length;for(r=--o/4+2|15,i[--r]=8*o;~o;)i[o>>2]|=l.charCodeAt(o)<<8*o--;for(p=l=0;p<r;p+=16){for(o=n;l<64;o=[t=o[3],a+((t=o[0]+[a&e|~a&t,t&a|~t&e,a^e^t,e^(a|~t)][o=l>>4]+ur[l]+~~i[p|15&[l,5*l+1,3*l+5,7*l][o]])<<(o=[7,12,17,22,5,9,14,20,4,11,16,23,6,10,15,21][4*o+l++%4])|t>>>-o),a,e])a=0|o[1],e=o[2];for(l=4;l;)n[--l]+=o[l]}for(r="";l<32;)r+=(n[l>>3]>>4*(1^l++)&15).toString(16);return r}const Hr=Object.freeze(Object.defineProperty({__proto__:null,default:Wr},Symbol.toStringTag,{value:"Module"})),Gr=Mr(Hr);var vr={exports:{}};(function(r,a){(function(e,t){r.exports=function(n,i,l,o,f){for(i=i.split?i.split("."):i,o=0;o<i.length;o++)n=n?n[i[o]]:f;return n===f?l:n}})()})(vr);var B=vr.exports;/**
* @license Apache-2.0
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ha=$a,ma=ya,ga=da,T;ha()?T=ma:T=ga;var Sa=T;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Ka=Ja,b=za,w=br;function Qa(r){var a,e,t;if(r==null)return w.call(r);e=r[b],a=Ka(r,b);try{r[b]=void 0}catch{return w.call(r)}return t=w.call(r),a?r[b]=e:delete r[b],t}var Ya=Qa;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function Ae(){throw new Error("not implemented")}var de=Ae;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var he=ye,me=be,ge=de,L;he()?L=me:L=ge;var V=L;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ht=typeof Uint16Array=="function"?Uint16Array:null,mt=ht;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var gt=bt,I=dt,er=mt;function St(){var r,a;if(typeof er!="function")return!1;try{a=[1,3.14,-3.14,I+1,I+2],a=new er(a),r=gt(a)&&a[0]===1&&a[1]===3&&a[2]===I-2&&a[3]===0&&a[4]===1}catch{r=!1}return r}var wt=St;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Vt=V,xt=x,hr=Bt,mr=new xt(1),nr=new Vt(mr.buffer),Jt=hr.HIGH,qt=hr.LOW;function zt(r,a,e,t){return mr[0]=r,a[t]=nr[Jt],a[t+e]=nr[qt],a}var gr=zt;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Kt=gr;function Qt(r){return Kt(r,[0,0],1,0)}var Yt=Qt;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var vn=J,Ir,C,D;vn===!0?(C=1,D=0):(C=0,D=1);Ir={HIGH:C,LOW:D};var sn=Ir;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var dn=oa,hn=fa,mn=wr,gn=Nr,Sn=Pr,U=[0,0];function wn(r,a){var e,t;return mn.assign(r,U,1,0),e=U[0],e&=hn,t=gn(a),t&=dn,e|=t,Sn(e,U[1])}var On=wn;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ai=sr,ei=cr,ti=$r,ni=Jr,ii=zr,oi=Qr,li=pr,fi=yr,ui=In,vi=xn,si=ri,ci=wr,$i=Pr,pi=2220446049250313e-31,yi=2148532223,E=[0,0],P=[0,0];function _i(r,a){var e,t;return r===0||li(r)||fi(r)?r:(vi(E),r=E[0],a+=E[1],a+=si(r),a<oi?ui(0,r):a>ni?r<0?ei:ai:(a<=ii?(a+=52,t=pi):t=1,ci(P),e=P[0],e&=yi,e|=a+ti<<20,t*$i(e,P[1])))}var bi=_i;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
