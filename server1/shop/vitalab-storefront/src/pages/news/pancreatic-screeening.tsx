        ...
        > */}
          ...
          <header className="col-span-3 mt-12 grid w-full max-w-[810px] gap-y-6 md:grid-in-hero">
            <Heading variant="heading">
              ЗБЕРЕЖІТЬ ЗДОРОВ’Я ПІДШЛУНКОВОЇ ЗАЛОЗИ
            </Heading>
          ...
          <section className="grid gap-y-10 grid-in-body">
            <div className="grid gap-y-6 text-m leading-6 text-gray-900 md:text-lg">
              <p className="px-4 sm:pr-8 md:max-w-[810px]">
                Підшлункова залоза є надважливим елементом у складній системі
                нашого організму. Вона відповідає за виділення ферментів, без
                яких неможливе перетравлення вуглеводів, жирів та білків, та
                продукування гормонів.
              </p>
              <p className="px-4 sm:pr-8 md:max-w-[810px]">
                Тому вкрай важливо якомога раніше розпізнати симптоми порушення
                роботи цього органу, щоб вчасно поставити діагноз та розпочати
                лікування.
              </p>
              <p className="px-4 sm:pr-8 md:max-w-[810px]">
                Перевірте основні показники роботи підшлункової залози зі
                знижкою 25%!
              </p>
            </div>
