          ...
          <section className="grid gap-y-10 grid-in-body">
            <div className="grid gap-y-6 text-m leading-6 text-gray-900 md:text-lg">
              <p className="px-4 sm:pr-8 md:max-w-[810px]">
                ...
                систем організму. Пропонуємо протягом весни доступну комплексну
            ...
            <p className="px-4 text-s">
              *Акція діє за умови замовлення досліджень на сайті з 01.04.2025 р.
              по 31.05.2025 р. Акційна ціна не враховує вартість забору
