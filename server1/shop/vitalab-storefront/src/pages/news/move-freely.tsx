          ...
          <section className="grid gap-y-10 grid-in-body">
            <div className="grid gap-y-6 text-m leading-6 text-gray-900 md:text-lg">
              <p className="px-4 sm:pr-8 md:max-w-[810px]">
                Ревматизм – це серйозне та підступне захворювання, яке вражає
                сполучну тканину. Найбільше від нього страждають серце та
                суглоби.
              </p>
              <p className="px-4 sm:pr-8 md:max-w-[810px]">
                Саме тому лікарі рекомендують хоча б раз на рік проходити
                спеціальне обстеження – ревматологічний скринінг. Здайте аналізи
                та переконайтеся, що ревматизм вам не загрожує, і зберігайте
                активність протягом багатьох років!
              </p>
              <p className="px-4 sm:pr-8 md:max-w-[810px]">
                Перевірте основні маркери ревматизму зі знижкою 25%!
              </p>
            </div>
              ...
              <div className="py-6 pl-8 pr-14">
                ...
                <div className="mt-10 grid items-center gap-6 md:grid-cols-[2fr_1fr]">
                  <div className="text-m">
                    <p className="line-through">Базова ціна - 565 грн.</p>
                    <p className="mt-2 text-base font-semibold text-red-500 md:text-lg">
                      Акційна ціна - 424 грн.*
                    </p>
                  </div>
