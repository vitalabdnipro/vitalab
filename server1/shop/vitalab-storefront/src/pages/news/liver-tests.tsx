      ...
      <div className="pb-32">
        ...
        > */}
          ...
          <header className="col-span-3 mt-12 grid w-full max-w-[810px] gap-y-6 md:grid-in-hero">
            <Heading variant="heading">ЗДОРОВА ПЕЧІНКА</Heading>
          ...
          <section className="grid gap-y-10 grid-in-body">
            <div className="grid gap-y-6 text-m leading-6 text-gray-900 md:text-lg">
              <p className="px-4 sm:pr-8 md:max-w-[810px]">
                Печінка є одним із найважливіших органів в організмі людини,
                адже вона бере участь у метаболізмі, виробленні жовчі, обміні
                холестерину і найголовніше – нейтралізує токсини.
              </p>
              <p className="px-4 sm:pr-8 md:max-w-[810px]">
                Тому контроль здоров'я печінки є дуже важливим для збереження
                гарного самопочуття.
              </p>
              <p className="px-4 sm:pr-8 md:max-w-[810px]">
                Контролюйте здоров’я печінки зі спеціальною знижкою 15%:
              </p>
            </div>
            <Card className="bg-white" shadow="small">
              <div className="py-6 pl-8 pr-14">
                <span className="">
                  Код 113 - Аланінамінотрансфераза (АЛТ, АлАТ){" "}
                </span>
                <div className="mt-10 grid items-center gap-6 md:grid-cols-[2fr_1fr]">
                  ...
                  <div className="flex justify-end">
                    <AddCartButton id="prod_01H3C3BRRF0MAF3HM5FCV3T8Y0" />
                  </div>
                </div>
              </div>
            </Card>
            <Card className="bg-white" shadow="small">
              <div className="py-6 pl-8 pr-14">
                <span className="">
                  Код 114 - Аспартатамінотрасфераза (АСТ, АсАТ){" "}
                </span>
                <div className="mt-10 grid items-center gap-6 md:grid-cols-[2fr_1fr]">
                  <div className="text-m">
                    <p className="line-through">Базова ціна - 130 грн.</p>
                  ...
                  <div className="flex justify-end">
                    <AddCartButton id="prod_01H3C3BRRJ17A9QW8JG5EQQTCR" />
                  </div>
                </div>
              </div>
            </Card>
            <Card className="bg-white" shadow="small">
              <div className="py-6 pl-8 pr-14">
                <span className="">
                  Код 117 - Гамма-глутамілтрансфераза (ГГТ,ГГТП){" "}
                </span>
                <div className="mt-10 grid items-center gap-6 md:grid-cols-[2fr_1fr]">
                  <div className="text-m">
                    <p className="line-through">Базова ціна - 130 грн.</p>
                  ...
                  <div className="flex justify-end">
                    <AddCartButton id="prod_01H3C3BRSPQCGH4WR70W048FAS" />
                  </div>
                </div>
              </div>
            </Card>
            <Card className="bg-white" shadow="small">
              <div className="py-6 pl-8 pr-14">
                <span className="">Код 119 - Лужна фосфатаза (ЛФ)</span>
                <div className="mt-10 grid items-center gap-6 md:grid-cols-[2fr_1fr]">
                  <div className="text-m">
                    <p className="line-through">Базова ціна - 130 грн.</p>
                    <p className="mt-2 text-base font-semibold text-red-600 md:text-lg">
                  ...
                  <div className="flex justify-end">
                    <AddCartButton id="prod_01H3C3BRRMNVS7AG61ZDNHVW88" />
                  </div>
                </div>
              </div>
            </Card>
            ...
            <Card className="bg-white" shadow="small">
              <div className="py-6 pl-8 pr-14">
                <span className="">
                  Код 392 - Білірубін загальний, прямий та непряма фракція
                  білірубіну
                </span>
                <div className="mt-10 grid items-center gap-6 md:grid-cols-[2fr_1fr]">
                  <div className="text-m">
                    <p className="line-through">Базова ціна - 280 грн.</p>
                    <p className="mt-2 text-base font-semibold text-red-600 md:text-lg">
                      Акційна ціна - 238 грн.*
                    </p>
                  </div>
                  <div className="flex justify-end">
                    <AddCartButton id="prod_01H3C3BRZ4RHXV0T0PXWCH9BGF" />
                  </div>
                </div>
              </div>
            </Card>
