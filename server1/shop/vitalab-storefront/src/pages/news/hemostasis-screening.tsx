      ...
      <div className="pb-32">
        ...
        > */}
          ...
          <header className="col-span-3 mt-12 grid w-full max-w-[810px] gap-y-6 md:grid-in-hero">
            <Heading variant="heading">СКРИНІНГ ГЕМОСТАЗУ</Heading>
          ...
          <section className="grid gap-y-10 grid-in-body">
            <div className="grid gap-y-6 text-m leading-6 text-gray-900 md:text-lg">
              <p className="px-4 sm:pr-8 md:max-w-[810px]">
                Гемостаз - біологічна система, що забезпечує, з одного боку,
                збереження рідкого стану циркулюючої крові, а з іншого –
                запобігає кровотечі та припиняє її.
              </p>
              <p className="px-4 sm:pr-8 md:max-w-[810px]">
                Перевірка гемостазу необхідна у багатьох випадках: для
                діагностики причин кровоточивості; перед оперативним втручанням;
                для діагностики, лікування та профілактики тромбозів; при
                плануванні та під час вагітності; за наявності аутоімунних
                захворювань; під час прийому антикоагулянтів, тощо.
              </p>
              <p className="px-4 sm:pr-8 md:max-w-[810px]">
                Своєчасна діагностика допоможе виявити найменші відхилення у
                згортанні крові, які тривалий час можуть безсимптомно протікати
                навіть у людини, яка веде здоровий спосіб життя.
              </p>
              <p className="px-4 sm:pr-8 md:max-w-[810px]">
                Контролюйте стан системи гемостазу зі знижкою 25%!
              </p>
            </div>
            <Card className="bg-white" shadow="small">
              <div className="py-6 pl-8 pr-14">
                <span className="">Код 02146 Пакет "Скринінг гемостазу"</span>
                <ul>
                  <li>• Аналіз крові загальний (автоматизований з лейкоформулою)</li>
                  <li>• Коагулограма скринінгова (протромбін):
                    <ul className="ml-4">
                      <li>- Міжнародне нормалізоване співвідношення (INR)</li>
                      <li>- Протромбіновий час (PT)</li>
                      <li>- Протромбін по Квіку</li>
                    </ul>
                  </li>
                  <li>• D-димер</li>
                </ul>
